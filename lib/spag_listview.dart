...
Future<Foodres> fetchChick() async {
  final response = await http.get('https://api.edamam.com/api/nutrition-data?app_id=${Keys.App_Id}&app_key=${Keys.App_key}&ingr=one%20spaghetti');
  final jsonResponse = jsonDecode(response.body);
  return Foodres.fromJson(jsonResponse);
}

class SpagList extends StatefulWidget {
  @override
  _SpagListState createState() => _SpagListState();
}

class _SpagListState extends State<SpagList> {
  Widget futureWidget() {
