...
Future<Foodres> fetchChick() async {
  final response = await http.get('https://api.edamam.com/api/nutrition-data?app_id=${Keys.App_Id}&app_key=${Keys.App_key}&ingr=one%20beef');
...
class BeefList extends StatefulWidget {
  @override
  _BeefListState createState() => _BeefListState();
}
