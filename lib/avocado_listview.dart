...
Future<Foodres> fetchChick() async {
  final response = await http.get('https://api.edamam.com/api/nutrition-data?app_id=2fee8088&app_key=91f50b7cadb87e4855057006e371ef2a&ingr=one%20avocado');
  final jsonResponse = jsonDecode(response.body);
  return Foodres.fromJson(jsonResponse);
}

class AvocadoList extends StatefulWidget {
  @override
  _AvocadoListState createState() => _AvocadoListState();
}

class _AvocadoListState extends State<AvocadoList> {
  Widget futureWidget() {
